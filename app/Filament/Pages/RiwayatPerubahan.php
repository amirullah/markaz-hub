...
class RiwayatPerubahan extends Page
{
    ...
    public const CHANGELOG = [
        [
            'date' => '25 Juni 2026',
            'changes' => [
                'Impor Daftar Produk: 2 pilihan untuk HPP pesanan LAMA — (1) "Sesuaikan sesuai TANGGAL pesanan" (tiap pesanan lama pakai modal yang berlaku saat tanggalnya; tepat bila file memuat perubahan harga MUNDUR/backdated, mis. upload tgl 10 tapi harga berubah tgl 4 → pesanan tgl 5 otomatis ikut harga tgl 4); (2) "Samakan dengan harga TERBARU" (timpa semua ke modal terkini). Default: HPP pesanan lama tidak diubah.',
