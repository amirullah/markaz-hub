...
class OrdersTable
{
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            // Tombol header: ambil SEMUA No. Pesanan sesuai filter (tanpa perlu centang satu-satu).
            // Kecil → salin ke clipboard; banyak (mis. tanpa filter, ribuan) → unduh .txt (clipboard
            // tak andal untuk teks raksasa).
            ->headerActions([
