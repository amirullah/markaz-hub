...
<head>
    ...
    <meta name="description" content="MarkazHub membantu seller Shopee, Tokopedia/TikTok, dan dropship Jakmall menghitung laba akurat, menemukan produk merugi, dan mengelola pesanan dalam satu aplikasi.">
    <style>
...
<body>
    ...
    <header class="hero">
        <div class="wrap">
            <span class="pill">📊 Untuk seller Shopee · Tokopedia/TikTok · Dropship Jakmall</span>
